...
const (
	...
	floxEnvBaseDir            = "/srv/host/k8s-daemonset.d/runtime/flox-runtime/env.d"
...
//   - Resolves environment: "category/name" maps to /srv/host/.../runtime/flox-runtime/env.d/{category}/{name}
...
func (p *FloxPlugin) resolveFloxEnvironment(floxEnv string) (string, error) {
	...
	// Matches the filesystem layout: /srv/host/k8s-daemonset.d/runtime/flox-runtime/env.d/{category}/{name}
